...
import net.soulhacker.journalApp.repository.JournalEntryRepository;
import net.soulhacker.journalApp.service.JournalEntryService;
...
public class JournalController {
    ...
    public ResponseEntity<List<JournalEntry>> getAll() {
        ...
        // Return the list of journal entries with an OK status
